...
import { showInputBox, nextOccuranceCommand, previousOccuranceCommand, currentTransactionOccuranceCommand, goToTransactionStartCommand, goToTransactionEndCommand, debugCurrentTransactionCommand, lastOccuranceCommand } from './commands';
...
export function activate(context: ExtensionContext) {
	...
	const loc = commands.registerCommand('tracetool.lastOccurance', (item) => lastOccuranceCommand(item));
	...
	context.subscriptions.push(abc, poc, noc, loc, eoc, gtc, gtbc, dctc);
